...
function AccordionItem({
  ...
  return (
    <AccordionPrimitive.Item
      ...
      className={cn("border not-last:border-b data-open:bg-muted/50", className)}
      {...props} />
  );
}
...
function AccordionContent({
  ...
  return (
    <AccordionPrimitive.Content
      ...
      <div
        className={cn(
          "space-y-2 h-(--radix-accordion-content-height) pt-0 pb-4 [&_a]:underline [&_a]:underline-offset-3 [&_a]:hover:text-foreground",
          className
        )}>
        {children}
      </div>
