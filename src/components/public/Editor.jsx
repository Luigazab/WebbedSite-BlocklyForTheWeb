...
import ModalDropdown from '../editor/ModalDropdown';
...
const Editor = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row w-full h-svh overflow-hidden rounded-lg p-2 gap-4" >
      {message && (
        ...
        {/* Blockly Workspace */}
        <div className="flex w-2/3 h-full md:overflow-hidden border-4 rounded-xl border-gray-600 relative bg-white">
